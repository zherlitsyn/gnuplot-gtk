...
#define COLUMN_HELP 1
/* Define to treat spacebar like any other keystroke. */
#define DISABLE_SPACE_RAISES_CONSOLE 1
...
/* Name of package */
#define PACKAGE "gnuplot-gtk"
/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""
/* Define to the full name of this package. */
#define PACKAGE_NAME "gnuplot-gtk"
/* Define to the full name and version of this package. */
#define PACKAGE_STRING "gnuplot-gtk 5.4.2"
/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gnuplot-gtk"
